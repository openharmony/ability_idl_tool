...
class hdi_compile_opt_test_02(Test):
    ...
    def set_idl_attr(self):
        ...
        command = f"{self._idl} --intf-type hdi --dump-ast -c "\
            f"-r ohos.hdi:{self.get_working_dir()} -o {self._output_path} "\
