...
class hdi_compile_opt_test_03(Test):
    ...
    def set_idl_attr(self):
        ...
        command = f"{self._idl} --intf-type hdi --dump-ast -c -c "\
            f"-r ohos.hdi:{self.get_working_dir()} -c -o {self._output_path} "\
            f"{idl_dir}/IFoo.idl {idl_dir}/IFooCallback.idl {idl_dir}/Types.idl"\
            f"| tee {self._output_path}"
