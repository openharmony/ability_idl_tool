 ...
 */
#ifndef OHOS_IDL_SA_INTERFACETYPE_EMITTER_H
#define OHOS_IDL_SA_INTERFACETYPE_EMITTER_H

#include "codegen/SA/sa_type_emitter.h"

namespace OHOS {
namespace Idl {
class SaInterfaceTypeEmitter : public SaTypeEmitter {
public:
...
private:
    std::string StubName(const std::string &name) const;
};
} // namespace Idl
} // namespace OHOS

#endif // OHOS_IDL_SA_INTERFACETYPE_EMITTER_H