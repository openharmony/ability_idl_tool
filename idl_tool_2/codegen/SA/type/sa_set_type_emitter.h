...
#ifndef OHOS_IDL_SA_SETTYPE_EMITTER_H
#define OHOS_IDL_SA_SETTYPE_EMITTER_H

#include "codegen/SA/sa_type_emitter.h"

namespace OHOS {
namespace Idl {
class SaSetTypeEmitter : public SaTypeEmitter {
public:
...
#endif // OHOS_IDL_SA_SETTYPE_EMITTER_H