...
#ifndef OHOS_IDL_SA_STRUCTTYPE_EMITTER_H
#define OHOS_IDL_SA_STRUCTTYPE_EMITTER_H

#include "codegen/SA/sa_type_emitter.h"

namespace OHOS {
namespace Idl {
class SaStructTypeEmitter : public SaTypeEmitter {
public:
...
private:
    std::vector<std::tuple<std::string, AutoPtr<SaTypeEmitter>>> members_;
};
} // namespace Idl
} // namespace OHOS

#endif // OHOS_IDL_SA_STRUCTTYPE_EMITTER_H