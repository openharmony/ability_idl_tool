...
#ifndef OHOS_IDL_SA_SEQTYPE_EMITTER_H
#define OHOS_IDL_SA_SEQTYPE_EMITTER_H

#include "codegen/SA/sa_type_emitter.h"

namespace OHOS {
namespace Idl {
class SaSeqTypeEmitter : public SaTypeEmitter {
public:
    ...
    void EmitCppPtrWriteVar(const EmitCppPtrVar &emitCppPtrVar, StringBuilder &sb) const override;
...
#endif // OHOS_IDL_SA_SEQTYPE_EMITTER_H