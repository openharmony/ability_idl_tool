...
#ifndef OHOS_IDL_SA_U16STRINGTYPE_EMITTER_H
#define OHOS_IDL_SA_U16STRINGTYPE_EMITTER_H

#include "codegen/SA/sa_type_emitter.h"

namespace OHOS {
namespace Idl {
class SaU16stringTypeEmitter : public SaTypeEmitter {
public:
...
#endif // OHOS_IDL_SA_U16STRINGTYPE_EMITTER_H