...
void SaTsServiceStubCodeEmitter::EmitInterfaceStubMethodImpls(StringBuilder &sb, const std::string &prefix) const
{
    ...
    sb.Append(prefix + TAB + "let localDescriptor = this.getDescriptor();\n");
    sb.Append(prefix + TAB + "let remoteDescriptor = data.readInterfaceToken();\n");
    sb.Append(prefix + TAB + "if (localDescriptor !== remoteDescriptor) {\n");
    sb.Append(prefix + TAB + TAB + "console.log(\"invalid interfaceToken\");\n");
    sb.Append(prefix + TAB + TAB + "return false;\n");
    sb.Append(prefix + TAB + "}\n");
    sb.Append(prefix + TAB + "console.log(\"onRemoteMessageRequest called, code = \" + code);\n");
    sb.Append(prefix + TAB + "switch(code) {\n");
    ...
    sb.Append(prefix + TAB + TAB + "default: {\n");
    sb.Append(prefix + TAB + TAB + TAB + "console.log(\"invalid request code\" + code);\n");
    sb.Append(prefix + TAB + TAB + TAB + "break;\n");
    sb.Append(prefix + TAB + TAB + "}\n");
    sb.Append(prefix + TAB + "}\n");
    sb.Append(prefix + TAB + "return false;\n");
    sb.Append(prefix + "}\n\n");
    ...
    const std::string &prefix) const
{
    ...
    sb.Append(prefix + TAB).Append("let promise = new Promise<void>((resolve,reject) => { \n");
    sb.Append(prefix + TAB + TAB).AppendFormat("this.%s(", MethodName(method->GetName()).c_str());
    for (int i = 0; i < paramNumber; i++) {
        AutoPtr<ASTParameter> param = method->GetParameter(i);
        if (param->GetAttribute() & ASTParamAttr::PARAM_IN) {
    ...
    sb.Append(prefix + TAB).Append("await promise;\n");
    ...
    const std::string &prefix, bool haveOutPara) const
{
    ...
    sb.Append(prefix + TAB).Append("resolve();\n");
    sb.Append(prefix).Append('}');
    sb.Append(");\n");
}
