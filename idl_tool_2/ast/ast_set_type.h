...
#ifndef OHOS_IDL_ASTSETTYPE_H
#define OHOS_IDL_ASTSETTYPE_H
...
namespace OHOS {
namespace Idl {
class ASTSetType : public ASTType {
public:
    ASTSetType() : ASTType(false), elementType_() {}
