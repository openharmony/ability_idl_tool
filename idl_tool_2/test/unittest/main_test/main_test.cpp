...
namespace OHOS::Idl {
class IdlTool2MainTest : public testing::Test {
public:
    IdlTool2MainTest() {}
    virtual ~IdlTool2MainTest() {}
...
void IdlTool2MainTest::SetUpTestCase() {}
void IdlTool2MainTest::TearDownTestCase() {}
void IdlTool2MainTest::SetUp() {}
void IdlTool2MainTest::TearDown() {}
 ...
 * @tc.desc: test IdlTool2Main.
 * @tc.type: FUNC
 */
HWTEST_F(IdlTool2MainTest, Main_Test_001, Level1)
{
    char* argv[] = {
        const_cast<char*>("./IdlTool2MainTest"),
        const_cast<char*>("-gen-cpp"),
        const_cast<char*>("-c"),
        const_cast<char*>("/data/test/resource/idl/IFoo.idl"),
